...
def mock_rainfall_data():
    # Return some mock anomalies for border provinces
    return [
        {"location_name": "Mae Sot", "value": 12.5, "unit": "mm", "date": datetime.now().strftime('%Y-%m-%d')},
        {"location_name": "Tak", "value": 8.2, "unit": "mm", "date": datetime.now().strftime('%Y-%m-%d')},
        {"location_name": "Kanchanaburi", "value": -5.0, "unit": "mm", "date": datetime.now().strftime('%Y-%m-%d')}
    ]
