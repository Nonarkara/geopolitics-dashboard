...
function CountryFactCard({
  ...
  return (
    <div className="border border-[var(--line)] p-3">
      ...
      <div
        className="pt-2 text-[14px] font-medium leading-5 text-[var(--ink)]"
        data-testid={testId}
      >
        {value}
      </div>
        ...
        <>
          ...
          >
            <div className="flex items-start gap-3">
              <div
                className="flex h-12 w-12 items-center justify-center border border-[var(--line)] bg-[var(--bg)] text-[26px]"
                aria-hidden="true"
              >
                {flagEmoji}
              </div>
              <div className="min-w-0 flex-1">
                <div className="text-[13px] font-semibold uppercase tracking-[0.14em] text-[var(--dim)]">
                  Official name
                </div>
                <div
                  className="pt-1 text-[15px] font-medium leading-5 text-[var(--ink)]"
