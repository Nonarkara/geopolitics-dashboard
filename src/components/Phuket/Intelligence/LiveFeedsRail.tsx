    ...
    >
      <div className="flex items-center justify-between gap-3 border-b border-[var(--line)] pb-2">
        ...
        <button
          type="button"
          onClick={() => void reload()}
          className="inline-flex items-center gap-2 rounded-full border border-[var(--line)] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--dim)] transition-colors hover:border-[var(--line-bright)] hover:text-[var(--cool)]"
      ...
      <div className="grid min-h-0 flex-1 gap-3 pt-3 xl:grid-cols-[1.15fr_0.95fr]">
        <div className="min-h-0 overflow-hidden rounded-2xl border border-[var(--line)] bg-[rgba(6,10,18,0.44)] p-3">
          <div className="mb-2 flex items-center gap-2">
            <Tv size={13} className="text-[var(--cool)]" />
        ...
        <div className="min-h-0 overflow-hidden rounded-2xl border border-[var(--line)] bg-[rgba(6,10,18,0.44)] p-3">
          <div className="mb-2 flex items-center gap-2">
            <Camera size={13} className="text-[var(--cool)]" />
