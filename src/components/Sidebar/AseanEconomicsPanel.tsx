    ...
    <div className="rounded-xl border border-[var(--line)] bg-[var(--bg-raised)] p-4">
      ...
      <div className="relative pt-4">
        <select
          ...
          className="w-full appearance-none rounded-lg border border-[var(--line)] bg-[var(--bg)] px-3 py-2.5 pr-10 text-[13px] font-medium text-[var(--ink)] outline-none transition-colors hover:border-[var(--line-bright)] focus:border-[var(--cool)]"
      ...
      {isLoading && !payload ? (
        <div className="mt-4 rounded-lg border border-[var(--line)] bg-[var(--bg)] p-3 text-[11px] leading-5 text-[var(--muted)]">
              ...
              {payload && payload.news.length > 0 ? (
                payload.news.map((item) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="block rounded-lg border border-[var(--line)] bg-[var(--bg-raised)] p-3 transition-colors hover:border-[var(--line-bright)]"
                  >
