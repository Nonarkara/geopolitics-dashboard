...
const CHANNELS: TVChannel[] = [
  ...
  },
  {
    ...
    code: "SG",
    name: "CNA",
    ytChannelId: "UC83jt4dlz1Gjl58fzQrrKZg",
    color: "#f59e0b",
  },
  {
    country: "Philippines",
  ...
  },
  {
    ...
    code: "AJ",
    name: "Al Jazeera",
    ytChannelId: "UCfiwzLy-8yKzIbsmZTzxDgw",
    color: "#a855f7",
  },
  {
    country: "Vietnam",
      ...
      <div className="flex items-center justify-between px-1.5 py-1 bg-[var(--bg-surface)]">
        ...
        <div className="flex items-center gap-1">
          ...
          <a
            href={
              channel.ytChannelId
                ? `https://www.youtube.com/embed/live_stream?channel=${channel.ytChannelId}`
                : `https://www.youtube.com/watch?v=${dynamicId}`
            }
            target="_blank"
    ...
    <section className="flex h-full flex-col bg-[var(--bg-surface)] p-3 overflow-visible">
      <div className="flex items-center justify-between pb-2">
        <div className="flex items-center gap-2">
          ...
          <div className="eyebrow">Regional monitors</div>
        </div>
      ...
      <div className="mt-1 text-[7px] font-mono tracking-[0.1em] text-[var(--dim)]">
        Source: YouTube Live · Click 🔊 for audio
      </div>
    </section>
  );
}
