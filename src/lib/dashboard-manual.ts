...
export const dashboardManualPages: ManualPage[] = [
    ...
    callouts: [
      {
        label: "Sidebar",
        description:
          "Watchlists and corridor context live here. Use it to understand the standing operating picture before reacting to a single headline.",
      },
      {
        label: "Map",
        description:
          "The central map is where incidents, borders, and overlays converge into a location-based read.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Economic and conflict panels tell you whether the signal is isolated, trending, or structurally persistent.",
      },
      {
        label: "Signal ticker",
        description:
  ...
  },
  {
    ...
    bullets: [
      "Pan to establish regional context, then zoom to inspect one corridor or border segment in detail.",
      "Clicking an incident or border region opens a selected-place read that summarizes immediate conditions.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Use rainfall, thermal, movement, and incident layers to confirm or challenge the story suggested by headlines and briefings.",
    ],
    callouts: [
      {
  ...
  },
  {
    ...
    callouts: [
      ...
      },
      {
        label: "Live news",
        description:
          "This panel shows corroborating or competing public reporting. Watch for source concentration and stale timestamps.",
      },
      {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Conflict trend lines matter because a single event can be misleading without a trend baseline.",
  ...
  },
  {
    ...
    bullets: [
      "Click incidents for tactical detail or click border regions for a broader geographic sector read.",
    ...
    callouts: [
      {
        label: "Click a signal or border",
        description:
  ...
  },
  {
    ...
    bullets: [
      "1. Orient on the map and identify the corridor or place that matters.",
    ...
    callouts: [
      ...
      },
      {
        ...
        description:
          "Finish by deciding whether the signal is local noise, a corridor pattern, or a broader regional shift.",
      },
    ],
  },
];
