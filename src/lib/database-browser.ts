...
export const databaseTableCatalog: DatabaseTableDescriptor[] = [
  ...
  },
  {
    ...
    description: "Permanent research archive of every news article, OSINT report, seismic event, traffic incident, disaster alert, and commodity price. Auto-tagged with border region, severity, and keywords.",
    category: "Research",
    columns: [
      "signal_type",
      "source_provider",
  ...
  {
    id: "visitor_movements",
    label: "Visitor Movements",
    description: "Border crossing, refugee, tourism, and trade flow data for each crossing point and region.",
    category: "Research",
    columns: [
      "crossing_point",
      "region",
  ...
  },
  {
    ...
    label: "Daily Signal Summary",
    description: "Pre-aggregated daily rollups of signal counts, severity averages, and keyword trends per region and type.",
    category: "Research",
    columns: [
      "summary_date",
      "region",
    ...
    tableName: "signal_daily_summary",
    selectList: [
      "summary_date",
      "region",
      "signal_type",
    ...
    latestExpression: "MAX(summary_date)::text",
  },
];
