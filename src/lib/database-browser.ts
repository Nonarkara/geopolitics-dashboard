...
export const databaseTableCatalog: DatabaseTableDescriptor[] = [
  ...
  },
  {
    id: "fire_events",
    label: "Fire Events",
    description: "NASA FIRMS hotspot observations used for thermal layers and corridor evidence.",
  ...
  },
  {
    id: "rainfall_data",
    label: "Rainfall Data",
    description: "Stored rainfall anomaly points for corridor-relevant locations.",
    category: "Environment",
  ...
  },
  {
    ...
    description: "Cross-border refugee and displacement aggregates used in movement overlays.",
    category: "Operations",
    columns: [
      "origin_country",
      "asylum_country",
