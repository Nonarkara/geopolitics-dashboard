...
export function buildThailandBriefing(
  ...
  return {
    ...
    summary: `${incidents.length} Thailand-linked signals are in the current operating picture, led by ${lead.properties.type.toLowerCase()} activity around ${lead.properties.location}.`,
    ...
    priorities: [
      ...
      indicators[0]
        ...
        : "Use border trade and FX spread as the lead market stress signal.",
    ...
    outlook:
      totalFatalities >= 5
        ...
        : "The current picture supports a controlled watch posture, with risk concentrated in western and southern sectors.",
  };
}
