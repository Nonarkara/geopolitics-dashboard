...
export const dashboardSurfaces: DashboardSurface[] = [
  ...
  },
  {
    ...
    title: "Sidebar",
    summary:
      "Command context, recent incidents, watchpoints, and convergence-oriented operator cues.",
  },
  {
    id: "map",
    title: "Border Map",
    summary:
      "DeckGL and raster overlays for conflict zones, incidents, fires, rainfall, flights, movements, aerosol, AQI, and PM2.5.",
  },
  {
    id: "bottom-strip",
    title: "Bottom Analytics Strip",
    summary:
      "Markets, conflict trends, trending keywords, and source health for rapid cross-checking.",
  },
  {
    id: "intel-rail",
...
export const architectureLayers: ArchitectureLayer[] = [
  {
    ...
    bullets: [
      "TopBar, BorderMap, Sidebar, BriefingPanel, NewsDesk, EconomicMonitor, ConflictTrends, TrendingKeywords, SignalTicker.",
  ...
  },
  {
    ...
    tone: "fusion",
    summary:
      "Library modules join siloed sources into news, tickers, package briefs, overlays, and corridor convergence.",
    bullets: [
      "`src/lib/intelligence.ts` deduplicates feeds, scores severity and freshness, and emits briefing/news/ticker/source views.",
      "`src/lib/convergence.ts` fuses incidents, news, markets, rainfall, thermal, and movement into corridor posture.",
...
export const internalApiCatalog: InternalApiDescriptor[] = [
  ...
  },
  {
    ...
    category: "Environment",
    purpose:
      "Returns rainfall anomaly points mapped onto corridor-relevant locations.",
    consumers: ["BorderMap", "convergence scoring"],
  ...
  },
  {
    ...
    consumers: ["BorderMap", "Sidebar", "convergence scoring"],
  ...
  },
  {
    ...
    category: "Operations",
    purpose:
      "Returns thermal hotspot events for fire layers and corridor thermal evidence.",
    consumers: ["BorderMap", "convergence scoring"],
  ...
  },
  {
    ...
    category: "Operations",
    purpose:
      "Provides movement arcs built from asylum and origin-country counts.",
    consumers: ["BorderMap", "convergence scoring"],
    upstreams: ["Postgres `population_movements`"],
    fallback: "Returns `fallbackRefugees` on query failure or empty result.",
  },
  {
    path: "/api/flights",
    category: "Operations",
  ...
  },
  {
    ...
    category: "Intelligence",
    purpose:
      "Scores corridor-level convergence and returns posture, alerts, evidence, and data gaps.",
...
export const externalProviderCatalog: ExternalProviderDescriptor[] = [
  ...
  },
  {
    ...
    category: "News",
    description: "Query-based RSS searches used to widen intelligence coverage around corridor terms.",
  ...
  },
  {
    ...
    category: "Markets",
    description: "Trending search RSS feeds used to detect cross-border narrative momentum.",
